        ...
        for (StudentMethodCall actual : results) {
            try {
                Context context = contextBuilder()
                        ...
                        .add("Exception message", actual.exception != null ? actual.exception.getMessage() : "")
                        .add("Exception stacktrace",
                                actual.exception != null ? ReflectionUtilsP.formatStackTrace(actual.exception) : "")
                ...
                if (expected instanceof Exception && !Exception.class.isAssignableFrom(
                    ...
                    assertEquals(expected.getClass(), actual.exception.getClass(), context,
                            r -> "BuildRail() did not throw an exception of the expected Type");
                    return;
                }

                Assertions2.assertEquals(expected, actual.invoked, context,
                        r -> "BuildRail() did not return the expected value!");
                return;
            } catch (Throwable e) {
                lastCall = e;
            }
        ...
        for (StudentMethodCall actual : results) {
            try {
                ...
                Assertions2.assertEquals(expected, actual.call.returnValue(), context,
                        r -> "CanBuildRail() did not return the expected value!");
                return;
            } catch (Throwable e) {
                lastCall = e;
            }
    ...
    public void testCanDrive(ObjectNode node) throws NoSuchMethodException {
        ...
        for (StudentMethodCall actual : results) {
            try {
                ...
                Assertions2.assertEquals(expected, actual.call.returnValue(), context,
                        r -> "CanDrive() did not return the expected value!");
                return;
            } catch (Throwable e) {
                lastCall = e;
            }
    ...
    public void testDrive(ObjectNode node) throws NoSuchMethodException {
        ...
        for (StudentMethodCall actual : results) {
            try {
                ...
                Assertions2.assertEquals(expected, actual.invoked, context,
                        r -> "Drive() did not return the expected value!");
                return;
            } catch (Throwable e) {
                lastCall = e;
            }
